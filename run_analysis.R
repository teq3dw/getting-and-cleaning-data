...
substr(activity[2, 2], 8, 8) <- toupper(substr(activity[2, 2], 8, 8)) # capitalize letter 8 in table position 2,2 (U in walkingUpstairs)
substr(activity[3, 2], 8, 8) <- toupper(substr(activity[3, 2], 8, 8)) # capitalize letter 8 in table position 3,2 (D in walkingDownstairs)
